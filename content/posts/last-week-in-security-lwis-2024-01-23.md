Title: Last Week in Security (LWiS) - 2024-01-23
Date: 2024-01-23 23:59
Category: LWiS
Tags: LWiS, Exploits, Tools
Slug: last-week-in-security-lwis-2024-01-23
Author: Erik
Summary: Microsoft hacked, GraphStrike (<a href="https://twitter.com/Octoberfest73" target="_blank">@Octoberfest73</a>), GPO based LPEs (<a href="https://twitter.com/decoder_it" target="_blank">@decoder_it</a>), AwaitFuscator (<a href="https://twitter.com/washi_dev" target="_blank">@washi_dev</a>), ProxyHelper2 (<a href="https://twitter.com/hoodoer" target="_blank">@hoodoer</a>), and more!

<aside class="m-note m-success">
<h3>Newsletter!</h3>
<p>Have you always wanted Last Week in Security delivered to your inbox instead of your RSS feed reader or manually checking this site? Well now you can! <a href="https://subscribe.badsectorlabs.com/subscription/form" target="_blank">Sign up here</a>.</p>
</aside>
<p>Last Week in Security is a summary of the interesting cybersecurity news, techniques, tools and exploits from the past week. This post covers 2024-01-15 to 2024-01-23.</p>
<section id="news">
<h2>News</h2>
<ul>
...
<ul>
<li><a href="https://www.jackphilipbutton.com/post/how-to-protect-evilginx-using-cloudflare-and-html-obfuscation" target="_blank">How to protect Evilginx using Cloudflare and HTML Obfuscation</a> - Some solid OPSEC tips on protecting your RTA infrastructure.</li>
<li><a href="https://github.com/spellshift/realm" target="_blank">Realm</a> -  Realm is a cross platform Red Team engagement platform with a focus on automation and reliability. This was in the LWiS 2023-10-24, but the <a href="https://www.youtube.com/watch?v=IDLMMiqV6ss&amp;t=16009s" target="_blank">ShmooCon talk</a> is what bubbled it back up for me and made me really look into it. The docs look great and I plan to play with this one very soon.</li>
<li><a href="https://github.com/mxrch/GHunt" target="_blank">GHunt</a> - Recently got an update (OAuth based instead of cookies). Check it out!</li>
<li><a href="https://github.com/JPG0mez/ADCSync" target="_blank">ADCSync</a> - Use ESC1 to perform a makeshift DCSync and dump hashes.</li>
<li><a href="https://github.com/snovvcrash/RemoteRegSave" target="_blank">RemoteRegSave</a> - A .NET implementation to dump SAM, SYSTEM, SECURITY registry hives from a remote host.</li>
</ul>
<aside class="m-frame">
<h3>Stats</h3>
