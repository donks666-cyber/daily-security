Title: Sponsor Demo - Altered
Date: 1970-01-01 00:00
Category: LWiS
Tags: LWiS, Exploits, Tools
Slug: sponsor-demo-altered
Author: Erik
Summary: 
...
<p>With affordable and enterprise-like labs, <a href="https://www.alteredsecurity.com/online-labs" style="color: #3bd267;" target="_blank">Altered Security</a> offers multiple Red Team hands-on courses for both on-prem and Azure Red Team with industry recognized certifications. Join more than 30K professionals from 130+ countries.</p>
<p>Enjoy 20% OFF on all the on-demand courses using <span style="color: #3bd267;"><strong>HackerSummer20OFF</strong></span> (Stripe) from 1st July to 22nd July 2024.</p>
</aside><ul>
